...
public class ValidateurVariables {
    public static void checkVariables(int revNetDecl1, int revNetDecl2, SituationFamiliale sitFam, int nbEnfants,
                                             int nbEnfantsHandicapes, boolean parentIsol) throws IllegalArgumentException{
